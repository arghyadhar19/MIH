				...
				<div class="col-md-4 offset-md-4 form login-form">
					<form method="POST">
						...
						<div class="form-group">
							<input class="form-control" type="textbox" name="name" id="name" placeholder="Enter Your Name">
						</div>
						<div class="form-group">
							<input class="form-control" type="textbox" name="amt" id="amt" placeholder="Enter Amount" required>
						</div>
						<div class="form-group">
							<input class="form-control button" type="button" id="btn" name="btn" value="Pay Now" onclick="pay_now()" />
						</div>
					</form>
				</div>
			</div>
