        ...
        <ul class="nav-list">
            ...
            <li class="profile">
                <div class="name_job">
                    ...
                    <div class="job">Return to Home Page</div>
                </div>
                    ...
                    <form action="signup-user.php" method="POST" autocomplete="">
                        ...
                        <div class="form-group">
                            <div class="input-box">
                                ...
                                <select name="oaf" id="profile">
                                    <option value="0" hidden>Opening Account For</option>
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="ph" placeholder="Phone Number" required value="<?php echo $ph ?>">
                        </div>
                        <div class="form-group">
                            <input class="form-control" type="email" name="email" placeholder="Email Address" required value="<?php echo $email ?>">
                        </div>
                        <div class="form-group">
                            <input class="form-control" type="text" name="AN" placeholder="AADHAR NO." required value="<?php echo $AN ?>">
                        </div>
                        <div class="form-group">
                            <div class="input-box">
                                <span class="details"></span>
                                <select name="G" id="profile">
